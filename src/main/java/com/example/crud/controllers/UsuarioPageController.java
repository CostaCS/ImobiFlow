...
public class UsuarioPageController {
    ...
    public String salvarUsuario(@ModelAttribute Usuario usuario,
        ...
        if (!usuario.getSenha().equals(confirmSenha)) {
            redirectAttributes.addFlashAttribute("erro", "Senhas não conferem");
            return "redirect:/usuario/cadastro";
        }

        if (usuarioService.emailJaCadastrado(usuario.getEmail())) {
            redirectAttributes.addFlashAttribute("erro", "E-mail já está cadastrado.");
            return "redirect:/usuario/cadastro";
        }
    ...
    public String processarResetSenha(@RequestParam String token, @RequestParam String novaSenha, @RequestParam String confirmarSenha, RedirectAttributes redirectAttributes) {
