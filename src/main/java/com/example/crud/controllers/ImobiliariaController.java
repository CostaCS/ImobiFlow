    ...
    */
    ...
    public String listarImobiliarias(
        ...
        if (busca != null && !busca.isEmpty()) {
            imobiliariasPage = imobiliariaService.buscarPorNomeOuCnpj(busca, pageable);
        } else {
            imobiliariasPage = imobiliariaService.getAllImobiliarias(pageable);
        }
        ...
        model.addAttribute("totalImobiliarias", imobiliariaService.contarTotalImobiliarias());
        model.addAttribute("imobiliariasComNegociacoes", imobiliariaService.contarImobiliariasComNegociacoes());
        model.addAttribute("imobiliariasSemNegociacoes", imobiliariaService.contarImobiliariasSemNegociacoes());
